...
class EditOldAddress extends StatefulWidget {
  ...
  final Doc data;
  EditOldAddress({Key? key, this.deliveryCharges = '',
    this.prodPrice= '',
    this.podTitle= '',
    this.imageUrl = '',
    this.addressId='',
  ...
  @override
  State<EditOldAddress> createState() => _EditOldAddressState();
}

class _EditOldAddressState extends State<EditOldAddress> {
                            ...
                            InkWell(
                              onTap: controller.isEnabled?()async{
                                await  controller.upDateAddress(
                                  ...
                                  AppNavigations.off(context, nextScreen: NewAddressPage(
                                    data: widget.data,
